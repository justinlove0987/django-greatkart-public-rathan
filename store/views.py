...
def product_detail(request, category_slug, product_slug):
    try:
        ...
        # exists method is going to return Boolean value
...
def submit_review(request, product_id):
    ...
    if request.method == "POST":
        try:
            ...
            form = ReviewForm(request.POST, instance=reviews) # instance parameter will check for you if it's a new one or not.
            form.save()
            ...
            if form.is_valid():
                ...
                data.save()
                messages.success(request, "Thank you! Your review has been summitted")
                return redirect(url)
